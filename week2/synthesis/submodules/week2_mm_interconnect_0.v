...
`timescale 1 ps / 1 ps
module week2_mm_interconnect_0 (
	...
	wire  [18:0] reg32_avalon_interface_0_avalon_slave_0_agent_m0_address;                           // reg32_avalon_interface_0_avalon_slave_0_agent:m0_address -> reg32_avalon_interface_0_avalon_slave_0_translator:uav_address
	...
	wire  [95:0] reg32_avalon_interface_0_avalon_slave_0_agent_rf_source_data;                       // reg32_avalon_interface_0_avalon_slave_0_agent:rf_source_data -> reg32_avalon_interface_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [95:0] reg32_avalon_interface_0_avalon_slave_0_agent_rsp_fifo_out_data;                    // reg32_avalon_interface_0_avalon_slave_0_agent_rsp_fifo:out_data -> reg32_avalon_interface_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> reg32_avalon_interface_0_avalon_slave_0_agent:cp_data
	...
	wire  [94:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_qsys_0_jtag_debug_module_agent:cp_data
	...
	wire  [94:0] reg32_avalon_interface_0_avalon_slave_0_agent_rp_data;                              // reg32_avalon_interface_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [94:0] nios2_qsys_0_jtag_debug_module_agent_rp_data;                                       // nios2_qsys_0_jtag_debug_module_agent:rp_data -> router_004:sink_data
	...
	week2_mm_interconnect_0_router router (
	...
	week2_mm_interconnect_0_router_001 router_001 (
	...
	week2_mm_interconnect_0_router_002 router_002 (
	...
	week2_mm_interconnect_0_router_003 router_003 (
	...
	week2_mm_interconnect_0_router_002 router_004 (
	...
	week2_mm_interconnect_0_router_002 router_005 (
	...
	week2_mm_interconnect_0_router_002 router_006 (
	...
	week2_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                 //       clk.clk
		.reset               (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                    //       clk.clk
		.reset              (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                    //       clk.clk
		.reset               (nios2_qsys_0_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	week2_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
